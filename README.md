...
This project started from a simple question: is a star rating really enough to capture how a customer feels? I tried reading the actual review text from over 11,000 product reviews on Amazon India and classifying the sentiment behind them.

One of the more interesting parts was the data itself — a single row in the dataset contained multiple reviews bundled together, which had to be separated before any analysis could happen.

Tools: Python, Pandas, NLTK, VADER Sentiment, WordCloud, Plotly
...
Tools: Python, Scikit-learn, Pandas, Seaborn, KMeans, PCA, Streamlit

Get in Touch

- GitHub: [github.com/VVNX13](https://github.com/VVNX13)
- LinkedIn: (www.linkedin.com/in/devano-bentara-wadja-medho-3979ba285)
- Email: (devanobentara@gmail.com)
